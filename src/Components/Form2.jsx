  ...
  return (
    <body class="page-custom-form">
      <form onSubmit={handleSubmit} className="form-container">
        ...
        />
        <h2>
          <i className="fas fa-image"></i> Profile Photo
        </h2>
        <input
          className="form-input"
          type="file"
        ...
        {formData.skills.map((skill, index) => (
          <div key={index} className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleArrayChange(e, index, "skills", "percentage")
              }
              min="0"
              max="100"
            />
        ...
        {formData.education.map((edu, index) => (
          <div key={index} className="nested-form-group">
            ...
            <input
              ...
              value={edu.branch}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "branch", "education")
              }
              required
            />
            <input
              ...
              value={edu.location}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "location", "education")
              }
            />
            <input
              className="form-input"
              ...
              value={edu.startYear}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "startYear", "education")
              }
              required
            />
            <input
              ...
              value={edu.endYear}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "endYear", "education")
              }
              required
            />
            <div className="form-group">
              <input
                ...
                value={edu.cgpa}
                onChange={(e) =>
                  handleNestedArrayChange(e, index, "cgpa", "education")
                }
                required
              />
              <select
                ...
                value={edu.cgpaType}
                onChange={(e) =>
                  handleNestedArrayChange(e, index, "cgpaType", "education")
                }
              >
        ...
        {formData.experience.map((exp, index) => (
          <div key={index} className="nested-form-group">
            <input
              ...
              value={exp.position}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "position", "experience")
              }
            />
            <input
              className="form-input"
              ...
              value={exp.company}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "company", "experience")
              }
            />
            ...
            <input
              ...
              onChange={(e) =>
                handleNestedArrayChange(e, index, "startMonth", "experience")
              }
            />
            <input
              className="form-input"
              ...
              value={exp.startYear}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "startYear", "experience")
              }
            />
            <input
              className="form-input"
              ...
              value={exp.endMonth}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "endMonth", "experience")
              }
            />
            <input
              className="form-input"
              ...
              value={exp.endYear}
              onChange={(e) =>
                handleNestedArrayChange(e, index, "endYear", "experience")
              }
            />
            <textarea
              className="form-input textarea"
              ...
              onChange={(e) =>
                handleNestedArrayChange(e, index, "internships", "experience")
              }
            />
            <button
              type="button"
        ...
        <h2>
          <i className="fas fa-globe-americas"></i> Languages
        </h2>
        {formData.languages.map((lang, index) => (
          <div key={index} className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleArrayChange(e, index, "languages", "percentage")
              }
              min="0"
              max="100"
            />
